...
<html>
	...
	<body>
		<h2><font color="white">NodeMCU V3 ESP8266 / ESP12E with MYSQL Database</font></h2>
		<ul class="topnav">
			<li><a href="index.php">Home</a></li>
			<li><a class="active" href="user data.php">User Data</a></li>
			<li><a class="active" href="user data copy.php">User Attendance</a></li>
		...
		<div class="container">
            <div class="row">
                <h3><font color="white">User Attendance Table</font></h3>
            </div>
            <div class="row">
